	...
	const className =
		type === 'button' || type === 'reset'
			...
			: content === 'Card' || content === `Invitation` || content === 'Banner'
				? 'px-4 py-4 text-lg font-semibold bg-blue-50 border-2 border-transparent rounded-md shadow-md hover:bg-blue-100 hover:border-blue-500 focus:bg-blue-100 focus:border-blue-500 transition-all'
